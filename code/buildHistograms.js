...
function makeHist_egs(old_csvdata, col, var_svg_id, xlabel) {
    ...
    old_maxbin = d3.max(old_csvdata, function(d) {
        return +d[col];
    });
    old_minbin = d3.min(old_csvdata, function(d) {
        return +d[col];
    });
    maxbin_egs = d3.max(old_csvdata, function(d) {
        return +d[col];
    });
    minbin_egs = d3.min(old_csvdata, function(d) {
        return +d[col];
    });
    ...
    yScale_egs = d3.scaleLinear().range([height2, 0]);

    var newNumBuckets1;
    if (path.includes("/data/PA_data/plan_metrics_PA_PRES16.csv")) {
        newNumBuckets1 = 9;
    } else {
    ...
    svg_egs
        ...
        .attr("height", function(d) {
            return height2 - yScale_egs(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
    ...
    svg_egs
        ...
        .attr("x", 35)
        .attr("y", 180)
        .text("Efficiency Gap > 0: Republican advantage")
        .style("font-size", "50%");
    svg_egs
        .append("text")
        .attr("x", 35)
        .attr("y", 190)
        .text("Efficiency Gap " + "\u2264" + " 0: Democratic advantage")
        .style("font-size", "50%");
...
function updateHist_egs(csvdata, col, var_svg_id) {
    ...
    // set up the bars
    bar_egs = svg_egs.selectAll(".bin_rect").data(bins);
...
function makeHist_cuts(old_csvdata, col, var_svg_id, xlabel) {
    ...
    maxbin = d3.max(old_csvdata, function(d) {
        return +d[col];
    });
    minbin = d3.min(old_csvdata, function(d) {
        return +d[col];
    });
    ...
    yScale_nb_cuts = d3.scaleLinear().range([height1, 0]);
    ...
    svg_nb_cuts
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_old(d.x0) +
                "," +
                yScale_nb_cuts(d.length) +
                ")"
            );
        })
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height1 - yScale_nb_cuts(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
...
function updateHist_cuts(csvdata, col, var_svg_id) {
    ...
    // set up the bars
    bar_nb_cuts = svg_nb_cuts.selectAll(".bin_rect").data(bins);
    ...
    bar_nb_cuts
        ...
        .attr(
            "width",
            xScale_nb_cuts(bins[0].x1) - xScale_nb_cuts(bins[0].x0) - 1
        )
        .attr("height", function(d) {
            return height1 - yScale_nb_cuts(d.length);
        })
...
function makeHist_mms(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_mms = d3.scaleLinear().range([height2, 0]);
    ...
    svg_mms
        ...
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height2 - yScale_mms(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
    ...
    svg_mms
        ...
        .attr("x", 35)
        .attr("y", 180)
        .text("Mean-Median > 0: Republican advantage")
        .style("font-size", "50%");
    svg_mms
        .append("text")
        .attr("x", 35)
        .attr("y", 190)
        .text("Mean-Median " + "\u2264" + " 0: Democratic advantage")
        .style("font-size", "50%");
}
...
function updateHist_mms(csvdata, col, var_svg_id) {
    ...
    // set up the bars
    bar_mms = svg_mms.selectAll(".bin_rect").data(bins);
...
function makeHist_hmss(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_hmss = d3.scaleLinear().range([height2, 0]);
    ...
    svg_hmss
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_old(d.x0) +
                "," +
                yScale_hmss(d.length) +
                ")"
            );
        })
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height2 - yScale_hmss(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
    ...
    svg_hmss
        ...
        .attr("x", 35)
        .attr("y", 180)
        .text("Republican won more than half the seats")
        .style("font-size", "50%");
    svg_hmss
        .append("text")
        .attr("x", 35)
        .attr("y", 190)
        .text("Democratic won more than half the seats")
        .style("font-size", "50%");
}
...
function updateHist_hmss(csvdata, col, var_svg_id) {
    ...
    // set up the bars
    bar_hmss = svg_hmss.selectAll(".bin_rect").data(bins);
...
function makeHist_votes(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_p_votes = d3.scaleLinear().range([height1, 0]);
    ...
    svg_p_votes
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_p_votes(d.x0) +
                "," +
                yScale_p_votes(d.length) +
                ")"
            );
        })
        .attr(
            "width",
            xScale_p_votes(bins[0].x1) - xScale_p_votes(bins[0].x0) - 1
        )
        .attr("height", function(d) {
            return height1 - yScale_p_votes(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
    ...
    svg_p_votes
        ...
        .attr("x", 75)
        .attr("y", 190)
        .text("Republican won more than half the votes")
        .style("font-size", "50%");
    svg_p_votes
        .append("text")
        .attr("x", 75)
        .attr("y", 200)
        .text("Democratic won more than half the votes")
        .style("font-size", "50%");
}
...
function updateHist_votes(csvdata, col, var_svg_id) {
    ...
    // set up the bars
    bar_p_votes = svg_p_votes.selectAll(".bin_rect").data(bins);
...
function makeHist_cuts2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_nb_cuts2 = d3.scaleLinear().range([height1, 0]);
    ...
    svg_nb_cuts2
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_old(d.x0) +
                "," +
                yScale_nb_cuts2(d.length) +
                ")"
            );
        })
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height1 - yScale_nb_cuts2(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.5);
...
function makeHist_votes2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_p_votes2 = d3.scaleLinear().range([height1, 0]);
    ...
    svg_p_votes2
        ...
        .attr("transform", function(d) {
            return (
                "translate(" +
                xScale_p_votes2(d.x0) +
                "," +
                yScale_p_votes2(d.length) +
                ")"
            );
        })
        .attr(
            "width",
            xScale_p_votes2(bins[0].x1) - xScale_p_votes2(bins[0].x0) - 1
        )
        .attr("height", function(d) {
            return height1 - yScale_p_votes2(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.5);
...
function makeHist_egs2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_egs2 = d3.scaleLinear().range([height2, 0]);
...
function makeHist_mms2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_mms2 = d3.scaleLinear().range([height2, 0]);
    ...
    svg_mms2
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_old(d.x0) +
                "," +
                yScale_mms2(d.length) +
                ")"
            );
        })
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height2 - yScale_mms2(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.5);
...
function makeHist_hmss2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    yScale_hmss2 = d3.scaleLinear().range([height2, 0]);
    ...
    svg_hmss2
        ...
        .attr("transform", function(d) {
            return (
                ...
                xScale_old(d.x0) +
                "," +
                yScale_hmss2(d.length) +
                ")"
            );
        })
        .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
        .attr("height", function(d) {
            return height2 - yScale_hmss2(d.length);
        })
        .style("fill", "#69b3a2")
        .style("opacity", 0.4);
